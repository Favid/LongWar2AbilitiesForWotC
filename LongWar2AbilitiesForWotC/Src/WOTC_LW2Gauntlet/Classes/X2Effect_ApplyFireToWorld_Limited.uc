...
event AddWorldEffectTickEvents( XComGameState NewGameState, XComGameState_WorldEffectTileData TickingWorldEffect )
{
    ...
    local array<int> FireEnvironmentDamageAfterNumTurns;

    // TODO: Config this
    FireEnvironmentDamageAfterNumTurns[0] = 0;
    FireEnvironmentDamageAfterNumTurns[1] = 10;
    FireEnvironmentDamageAfterNumTurns[2] = 10;
    FireEnvironmentDamageAfterNumTurns[3] = 10;
    ...
    if (FireEndingIndices.Length > 0)
    {
        for (NumTurns = 1; NumTurns <=3; NumTurns++)
        {
            ...
            if (NumTurns >= FireEnvironmentDamageAfterNumTurns.Length)
            {
            ...
            {
                NumTurnEnvDamIdx = Clamp(NumTurns, 0, FireEnvironmentDamageAfterNumTurns.Length);
                DamageEvent.DamageAmount = FireEnvironmentDamageAfterNumTurns[NumTurnEnvDamIdx]; 
            }
