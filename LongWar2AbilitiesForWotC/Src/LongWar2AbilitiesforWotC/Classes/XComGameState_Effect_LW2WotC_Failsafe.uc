//---------------------------------------------------------------------------------------
//  FILE:    XComGameState_Effect_LW2WotC_Failsafe.uc
...
class XComGameState_Effect_LW2WotC_Failsafe extends XComGameState_BaseObject;

function XComGameState_Effect_LW2WotC_Failsafe InitComponent()
{
	return self;
}
...
function EventListenerReturn PreAcquiredHackReward(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID, Object CallbackData)
{
	...
	{
		if(`SYNC_RAND(100) < class'X2Ability_LW2WotC_PassiveAbilitySet'.default.FAILSAFE_PCT_CHANCE)
		{
