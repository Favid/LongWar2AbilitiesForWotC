//---------------------------------------------------------------------------------------
//  FILE:    XComGameState_Effect_LW2WotC_SteadyWeaponListener.uc
...
class XComGameState_Effect_LW2WotC_SteadyWeaponListener extends XComGameState_Effect;

function XComGameState_Effect_LW2WotC_SteadyWeaponListener InitComponent()
{   
    return self;
}
